<template>
  <div class="view-container">
    ...
    <div class="project-box">
      <!-- <div class="title">Weather App (vanilla JS)</div> -->
      <div class="info-box">
        <h3>Weather App (vanilla JS)</h3>
        <p>
    ...
    <div class="project-box">
      <!-- <div class="title">Timeline Component</div> -->
      <div class="info-box">
...
.project-box {
  // border: solid 3px $black-olive-lighten;
